...
userRouter.get("/:nickname/stickers",jwtMiddleware,stickerController.getStickers); //방문자 기록 페이지 조회
userRouter.post('/:id/sticker',stickerController.postSticker); //Host 스티커 등록
...
userRouter.patch('/:nickname/message',jwtMiddleware,stickerController.postMessage);
